...
public class MappersTest {
    ...
    @Test
    public void mapBigDecimalString() {
        String input = "1 234,56 zł";
        String expected = "1234.56";
        String actual = Mappers.mapBigDecimalString(input);
    ...
    public void mapToInvoice() {
        ...
        String actual = Mappers.mapToInvoice(invoicePosition).toString();
        String expected = "Invoice{falseString='false', " +
                "KodWaluty='PLN', " +
                "P_1='4', " +
                "P_2A='6', " +
                "P_3A='1', " +
